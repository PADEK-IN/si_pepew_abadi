...
class ImageHandler {
    ...
    private $target_dir_bukti = "assets/img/bukti/";
    private $max_file_size = 2000000; // Maksimum ukuran file dalam byte (2000KB)
    ...
    // image profile
    public function uploadImageBukti($file) {
        $uploadOk = 1;
        $imageFileType = strtolower(pathinfo($file["name"], PATHINFO_EXTENSION));
        $target_file = $this->target_dir_bukti . basename($file["name"]);
