                        ...
                        <div class="col-md-8 col-lg-6">
                            <form action="/admin/barang/update/<?= $barang['id'] ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukan Nama Barang" value="<?= $barang['nama'] ?>" />
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="satuan" id="satuan" placeholder="Masukan Satuan Barang" value="<?= $barang['satuan'] ?>" />
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="berat" id="berat" placeholder="Masukan Berat Barang  (gram)" value="<?= $barang['berat'] ?>" />
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="stok" id="stok" placeholder="Masukan Stok Barang" value="<?= $barang['stok'] ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        <?php foreach ($kategori as $item): ?>
                                            <option value="<?= $item['id']; ?>" <?= $barang['id_kategori']===$item['id']?'selected':'' ?>><?= $item['nama']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" name="harga" class="form-control" placeholder="100.000" aria-label="harga" aria-describedby="basic-addon1" value="<?= $barang['harga'] ?>" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="/assets/img/barang/<?= $barang['gambar']?>" alt="gambar" width="70px">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="deskripsi" id="deskripsi"><?= $barang['deskripsi']?></textarea>
                                </div>
