<div class="container">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="multi-filter-select" class="display table table-striped table-hover text-center">
                                    ...
                                    <tbody>
                                        <?php if (isset($adminUser) && (is_iterable($adminUser) || is_object($adminUser))): ?>
                                            <?php foreach ($adminUser as $index => $item): ?>
                                            <tr>
                                                <td><?php echo $index + 1; ?></td>
                                                <td>
                                                    <a href="/admin/admin/detail/<?php echo $item['id']; ?>"><?php echo $item['nama']; ?></a>
                                                </td>
    ...
    <script>
        ...
        function printReport() {
            ...
            // Laporan
            printWindow.document.write('<h2 style="text-align: center;">Laporan Data Admin</h2>');
            ...
            printWindow.onafterprint = function() {
                ...
                table.id = originalId;
                printWindow.close();
                // window.location.href = '/admin/admin-list'; // Kembali ke halaman awal setelah print
            };
        }
