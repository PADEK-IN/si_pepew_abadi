<main id="main">
    ...
    <form action="/checkout/store" id="form-payment" method="post">
                ...
                <div class="col-lg-8 d-flex flex-column py-2 justify-content-between" style="height: 150px;">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex gap-1">
                            <span class="text-center" style="width: 30px;" id="jumlah-<?= $barang['id'] ?>">x <?= $barang['jumlah'] ?></sopan>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container my-2 d-flex align-items-center gap-2 rounded-lg shadow py-2 px-5 position-relative">
                <div class="col-lg-8 d-flex flex-column py-2 wrap">
                    ...
                    <div>
                        ...
                        <div class="fs-6 gap-1 text-secondary" id="total">Total Belanja: <?= number_format($total, 2, ',', '.') ?></div>
                        <div class="fs-6 gap-1 text-secondary" id="ppn">PPN 11%: <?= number_format($ppn, 2, ',', '.') ?></div>
                    </div>
                    <div class="d-flex justify-content-between">
                        <input type="text" class="d-none" readonly name="id_keranjang" value="<?= $ids ?>">
                        <input type="number" class="d-none" readonly name="ongkir" id="ongkir" value="0">
                        <input type="number" class="d-none" readonly name="jumlah" value="<?= $barang['jumlah'] ?>">
                        <input type="number" class="d-none" readonly name="total" id="total-input" value="<?= $total ?>">
                        <div class="fs-4 gap-1 text-primary" id="net">Net: Rp. <?= number_format(($net), 2, ',', '.') ?></div>
                    </div>
                </div>
            </div>
        </div>
